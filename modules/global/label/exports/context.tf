...
variable "environment" {
  type        = string
  default     = null
  description = "ID element. Usually used for env e.g. 'l', 's', 't1', 't2'"
}

variable "region" {
  type        = string
  default     = null
  description = "ID element. Usually used for region, e.g. 'eu-central-1', 'ap-northeast-1'"
}
...
variable "name" {
  ...
  default     = null
  description = <<-EOT
    ID element. Usually the component or solution name, e.g. 'rds' or 'ecs'.

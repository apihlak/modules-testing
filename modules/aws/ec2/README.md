...
| <a name="module_zt_whitelist"></a> [zt\_whitelist](#module\_zt\_whitelist) | https://yolo-terraform-modules.s3.eu-central-1.amazonaws.com/defaults/whitelist-v0.0.4.tar.gz | n/a |
...
| <a name="input_ingress_rules"></a> [ingress\_rules](#input\_ingress\_rules) | List of ingress rules to create by name | `list(string)` | <pre>[<br>  "ssh-tcp"<br>]</pre> | no |
